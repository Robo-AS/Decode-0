...
public class ConfigureColorRangefinder extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        crf.setPin0Digital(ColorRangefinder.DigitalMode.HSV, 200 / 360.0 * 255, 320 / 360.0 * 255); // purple
        crf.setPin0DigitalMaxDistance(ColorRangefinder.DigitalMode.HSV, 10); // 10mm or closer requirement
        crf.setPin1Digital(ColorRangefinder.DigitalMode.HSV, 80 / 360.0 * 255, 150 / 360.0 * 255); // green
