...
public class TrajectoryFollower {
    ...
    public void setTrajectory(Trajectory t, double nowSec){
        ...
        endState = (t != null && !t.allStates().isEmpty())
                ? t.allStates().get(t.allStates().size()-1)
                : null;
    }
    ...
    public void update(double nowSec){
        ...
        // Feedforward for heading
        double wFF = ref.omega + kFFAlpha * ref.alpha;

        // PIDF on Frenet axes (long has FF=ref.v, lat FF=0)
