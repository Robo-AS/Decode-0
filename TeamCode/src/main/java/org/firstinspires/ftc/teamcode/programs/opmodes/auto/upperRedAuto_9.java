...
public class upperRedAuto_9 extends OpMode {
    ...
    private final Pose startPose = new Pose(122.99, 124.01, Math.toRadians(36)); // 180 - 144
    private final Pose outtake = new Pose(93.438, 92.754, Math.toRadians(0));    // 180 - 180
    ...
    private final Pose leavePoint = new Pose(112.57, 83.57, Math.toRadians(0));
    ...
    private void buildPaths() {
        ...
        outtaking2 = follower.pathBuilder()
                // Mirroring the control point X: 144 - 60.75 = 83.25
    ...
    public void loop() {
        ...
        // Set isRedAlliance to true and verify turret loop parameters
        robot.turret.loopAuto(true, follower.getPose(), 146, 144);
