    ...
    private void autonomousPathUpdate() {
        switch (pathState) {
            case -1:
                ...
                pathSubState = 0;
                waitTimer.resetTimer();
                pathTimeoutTimer.resetTimer(); // Reset here
                break;
            case 0:
                ...
                pathTimeoutTimer.resetTimer(); // ADDED
                pathState = 1;
                break;
            case 1:
            ...
            case 5:
                ...
                pathTimeoutTimer.resetTimer(); // ADDED - This fixes Intake 3
                pathState = 7;
                break;
            case 7:
                if (follower.getCurrentTValue() > 0.5) {
            ...
            case 8:
                ...
                pathTimeoutTimer.resetTimer(); // ADDED - This fixes Intake 4
                pathState = 9;
                break;
            case 9:
                if (follower.getCurrentTValue() > 0.5) {
